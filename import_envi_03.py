...
list_station_ids=[64, 76, 78, 367, 338]
city_dic=dict()
city_dic={
    64: 'Modiin',
    76: 'Carmei Yosef',
...
while flag_prfrm:
    ...
    if t_crnt>t_next:
        ...
        for sttn_id in list_station_ids:
            ...
            r_by_loc_latest = requests.get(html_string,headers={'Authorization': 'ApiToken 71e67c41-8478-4310-9293-196f559493ca','envi-data-source': 'MANA'})
    ...
    time.sleep(10 * 60)
a=1
#pyinstaller --onefile import_envi_03.py